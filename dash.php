...
<body  style="background-image: linear-gradient(navy,
orange);">
<div class="header">
<div class="row">
<div class="col-lg-6">
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px; background-color: gold;"><b>Enter Quiz Details</b></span><br /><br />
